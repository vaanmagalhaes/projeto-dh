...
Visual brutalista/zine: bordas grossas pretas, sombras sólidas offset e tipografia em caixa alta, com um glow neon sutil (ciano/rosa) por trás das sombras como acento — referência à estética pulp e street art. Paleta e tokens em `:root` no [index.css](src/index.css).
